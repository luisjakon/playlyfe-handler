...
func (h *Handler) ContextHandler(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// merge contexts; give priority to net context
	ctx = context.WithValue(ctx, "hctx", h.Context)
	// execute graphql query
	result, _ := (h.Executor).Execute(ctx, params.Query, params.Variables, params.OperationName)
...
func (h *Handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	// Take middleware contexts into account
